...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			["Risk",				"risk",				"Menu Designer and Artist",									"https://x.com/RiskZtuff",			"FFC200"],
			["Gatix",				"gatix",			"Sticker Artist and Editor Icons",		"https://x.com/gatidin_W",			"EC8C32"],
			["Ambush",				"ambush",			"Hold Cover Editor Icon and Chris Sticker Artist",							"https://x.com/itsmeambush",		"660000"],
			["FrankArt",			"frank",			"Chart Editor Toys and Stickers",							"https://x.com/vsMandePal",			"FF7E5D"],
			["Jhonlas",				"jhonlas",			"Logo, 16x16 Cheese Icon and Sticker Artist",											"https://www.youtube.com/@Jhonlas","FFC200"],
			["FourTag",				"tag",				"Sticker Artist",											"https://x.com/4t4gg",				"FF8810"],
			["HeroMax",				"heromax",			"Sticker Artist",											"https://x.com/heromax_2498",		"CCCCCC"],
			["FG",					"fg",				"Sticker Artist",											"https://x.com/pastadeciruela",		"CC603C"],
			[""],
			["Psych Engine Team"],
