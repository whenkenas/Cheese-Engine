...
@:structInit class SaveVariables {
	...
	public var strumlineBackgroundOpponent:Float = 0.0;
...
class ClientPrefs {
	...
	public static function updateFPSCounter():Void
	{
		if(Main.fpsVar != null)
		{
			var isVisible:Bool = data.fpsMode != 'Off';
			var isBgVisible:Bool = data.debugBgOpacity > 0;
			...
			{
				Main.fpsVar.fpsValue.visible = isVisible;
				Main.fpsVar.fpsLabel.visible = isVisible;
				Main.fpsVar.memNow.visible = isVisible;
				Main.fpsVar.memMax.visible = isVisible;
				Main.fpsVar.coreName.visible = isVisible;
				Main.fpsVar.buildData.visible = isVisible;
			}
			
			if(Main.fpsVar.bgShape != null)
			{
				Main.fpsVar.bgShape.visible = isBgVisible && isVisible;
			}
			
			if(Main.fpsVar.infoDisplay != null)
			{
				Main.fpsVar.infoDisplay.visible = isVisible;
			}
			
			Main.fpsVar.setBackgroundOpacity(data.debugBgOpacity);
		}
	}
